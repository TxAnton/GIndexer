...
def fetch_paper(paper_id):
    ...
    fields = "title,authors,year,doi,fieldsOfStudy,venue,openAccessPdf"
    # fields = "title,authors,year,abstract,doi,fieldsOfStudy,citationCount,referenceCount,venue"
    url = f"{base_url}{paper_id}?fields={fields}"
    print(f"Fetching paper data from: {url}")
...
#%%
#%%
raw_id = "649def34f8be52c8b66281af98ae884c09aef38b"
